            ...
            <Row>
                ...
                <Col style={{marginTop: 100}}>
                    ...
                    <div className="isi tengah">
                        ...
                        <p>2. Gambar yang bisa dideteksi sebagai asli adalah gambar yang sudah dilatih dalam dataset</p>
                        <p>3. Hanya dapat mendeteksi manusia</p>
                        <p>4. Hanya dapat menerima input JPG</p>
                    </div>
                    <div className="isi terima kasih">
                        ...
                        <p>3. Medium</p>
                        <p>4. CodingMSTR</p>
                        <p>4. Bapak agus budi dharwaman</p>
